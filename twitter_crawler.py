...
def get_discord_webhook(tweet_url: str):
    if "CUBE_LIGHTSUM" in tweet_url:
        return "https://discord.com/api/webhooks/1162632189553410149/-jjVQRTX3kIhzDbOHecPMi6cOtqixrmS964LOsY082ymcYyDS5lvoyCnuF0FVZu3aZFW"
    elif "STAYC_official" in tweet_url or "STAYC_talk" in tweet_url:
        return "https://discord.com/api/webhooks/1162736592457310268/9UDH3V-4VhKACIOXvkzEmc-1M-9Sj5o94sOlIewtGWj0WsaEuVFBrpynWNBLNsCnEesk"
...
def get_profile_from_tweet(tweet_url: str):
    if "CUBE_LIGHTSUM" in tweet_url:
        return "LIGHTSUM·라잇썸 (@CUBE_LIGHTSUM)", "https://pbs.twimg.com/profile_images/1704148378870026240/3gLE-6ta_400x400.jpg"
    elif "STAYC_official" in tweet_url:
        return "STAYC(스테이씨) (@STAYC_official)", "https://pbs.twimg.com/profile_images/1683115325875949569/XLbXmPdE_400x400.jpg"
    elif "STAYC_talk" in tweet_url:
        return "STAYC (@STAYC_talk)", "https://pbs.twimg.com/profile_images/1655501267630981121/P9xprmtw_400x400.jpg"
    elif "_EL7ZUPofficial" in tweet_url:
        return "EL7Z UP OFFICIAL (_EL7ZUPofficial)", "https://pbs.twimg.com/profile_images/1691461887291162624/dtlS3dKA_400x400.jpg"